...
INSERT INTO `busquedas_temp` (`id`, `id_categorias`, `id_usuario`, `id_localidad`, `id_cat_nodb`, `fecha_ini`, `fecha_fin`, `busqueda`, `vencido`) VALUES
	(2, 22, 8, 9, 0, '2014-11-24 01:47:22', '2014-11-27 00:53:35', 'Necesito un herreo urgente', 0),
	(3, 28, 1, 202, 0, '2014-11-22 21:44:19', '2014-11-14 00:53:35', 'Hola buen dia busco un jardinero para mi casa tiene aproximadamente 100mts ', 0),
	(4, 1, 2, 294, 0, '2014-11-22 03:46:11', '2014-12-09 00:53:35', 'Se me rompio el motor de mi gol 1989 busco alguien que lo repare a buen precio', 0),
	(5, 12, 3, 295, 0, '2014-11-21 11:02:36', '2014-12-14 00:53:35', 'Necesitaria alguien que me haga un vestido para mi casamiento', 0),
	(6, 13, 4, 289, 0, '2014-11-20 11:47:19', '2014-12-09 00:53:35', 'Buenos dias busco peluquero/a a domicilio', 0),
	(7, 34, 5, 317, 0, '2014-11-19 07:03:02', '2014-12-16 00:53:35', 'Busco niñera responsable que cuide de mis hijos entre las 8 y 14 hs', 0),
	(14, 40, 1, 303, 3, '2014-11-28 11:18:09', '2014-12-02 11:16:00', 'busco programador web que pueda hacer mi pagina , tengo un local de ropa , necesito un ecomerce y fabebook', 0),
	(16, 25, 1, 166, NULL, '2014-11-28 11:34:40', '2014-11-30 11:34:00', 'necesito un carpintero para hacer un placar grande para guardar mis zapatos', 0),
	(17, 36, 1, 303, NULL, '2014-11-28 11:38:17', '2014-12-04 11:37:00', 'electricista presupuesto rep luces', 0);
...
-- Dumping structure for table servix_db.cat_nodb
DROP TABLE IF EXISTS `cat_nodb`;
CREATE TABLE IF NOT EXISTS `cat_nodb` (
...
-- Dumping data for table servix_db.cat_nodb: ~0 rows (approximately)
DELETE FROM `cat_nodb`;
/*!40000 ALTER TABLE `cat_nodb` DISABLE KEYS */;
INSERT INTO `cat_nodb` (`id`, `id_usuario`, `categoria`, `comentario`, `fecha`) VALUES
	(1, 1, 'prueba', 'bueba', '2014-11-30 11:06:59'),
	(3, 1, 'programador web', 'busco programador web que pueda hacer mi pagina , tengo un local de ropa , necesito un ecomerce y fabebook', '2014-12-02 11:16:00'),
	(4, 1, 'programador web', 'busco programador web que pueda hacer mi pagina , tengo un local de ropa , necesito un ecomerce y fabebook', '2014-12-02 11:16:00');
/*!40000 ALTER TABLE `cat_nodb` ENABLE KEYS */;
...
INSERT INTO `ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
	('b29444fe5886fcf14aac1beb721d7f45', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36', 1417187568, 'a:3:{s:9:"user_data";s:0:"";s:8:"busqueda";a:2:{s:4:"post";a:2:{s:8:"servicio";s:7:"Herrero";s:9:"localidad";s:12:"Buenos Aires";}s:3:"url";a:2:{s:8:"servicio";s:7:"herrero";s:9:"localidad";s:12:"buenos-aires";}}s:9:"logged_in";a:13:{s:2:"id";s:1:"1";s:5:"email";s:14:"pepe@gmail.com";s:6:"nombre";s:5:"Pedro";s:8:"apellido";s:11:"DonCorlione";s:3:"dni";s:8:"12918888";s:9:"direccion";s:19:"Av. Libertador 5966";s:8:"telefono";s:9:"4444-5587";s:4:"foto";s:36:"b947763fde0584f5278ca2236886d829.jpg";s:6:"estado";s:1:"1";s:14:"ultima_edicion";s:19:"0000-00-00 00:00:00";s:10:"foto_thumb";s:42:"b947763fde0584f5278ca2236886d829_thumb.jpg";s:9:"foto_path";s:59:"assets/images/usuarios/b947763fde0584f5278ca2236886d829.jpg";s:15:"foto_thumb_path";s:65:"assets/images/usuarios/b947763fde0584f5278ca2236886d829_thumb.jpg";}}');
...
INSERT INTO `consultas_servicios` (`id`, `id_servicio`, `id_usuario`, `fecha`, `consulta`) VALUES
	...
	(6, 208, 1, '2014-11-19 22:11:55', 'me gustaria contactarte para ver cuanto me sale hacer una puerta'),
	(7, 208, 1, '2014-11-19 22:11:55', 'asdsadasdasdadasd'),
	(8, 208, 1, '2014-11-19 22:11:55', 'sadasdsasadsdasadasdasd'),
	(9, 208, 1, '2014-11-19 22:11:57', 'sadsadasdasdsada'),
	(10, 208, 1, '2014-11-19 22:11:58', 'asdasdsadsadsad'),
	(11, 208, 1, '2014-11-19 22:11:59', 'asdasdsadsadsasdadas'),
	(12, 208, 1, '2014-11-19 23:11:00', 'wewrewrwerwerewrwerwer'),
	(13, 208, 1, '2014-11-19 23:11:00', 'asdasdsadasdsadasdsad');
...
-- Dumping data for table servix_db.localidades: ~2.146 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=latin1 COMMENT='Guarda las postulaciones temporales de servicios';

-- Dumping data for table servix_db.postulaciones_temp: ~18 rows (approximately)
...
-- Dumping data for table servix_db.recomendaciones: ~0 rows (approximately)
...
INSERT INTO `usuarios` (`id`, `email`, `clave`, `nombre`, `apellido`, `dni`, `telefono`, `direccion`, `foto`, `codigo`, `estado`, `fecha_creacion`, `fecha_mod_estado`, `ultima_edicion`) VALUES
	(1, 'pepe@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Pedro', 'DonCorlione', '12918888', '4444-5587', 'Av. Libertador 5966', 'b947763fde0584f5278ca2236886d829.jpg', 'aaaaaaaaa', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '2014-11-28 11:11:49'),
	(2, 'usuario1@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Juan', 'Moreno', '12918883', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa1', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(3, 'usuario2@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Sofia', 'Carlo', '32918888', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa2', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(4, 'usuario3@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Melina', 'Paz', '12918488', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa3', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(5, 'usuario4@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Roberto', 'Funiet', '12918856', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa4', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(6, 'usuario5@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Juliana', 'Brandon', '12518888', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa5', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(7, 'usuario6@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Sebastian', 'Ortega', '12348888', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa6', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(8, 'horacio@hotmail.com', 'd2322d37ded062860f40d5e9791b45e6', 'horacio', 'moreno', '35049207', '1134090733', 'av juan b justo 2195', '5198225b4dcf3938b80db9a5ccba1c43.jpg', '78574938a220391f2ac5710004fe84cd', 0, '2014-11-22 02:11:05', '2014-11-22 02:11:05', '2014-11-28 01:11:34');
