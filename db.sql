...
-- Dumping data for table servix_db.busquedas_temp: ~9 rows (approximately)
...
-- Dumping data for table servix_db.cat_nodb: ~3 rows (approximately)
...
-- Dumping data for table servix_db.localidades: ~2.383 rows (approximately)
...
-- Dumping data for table servix_db.provincias: ~26 rows (approximately)
...
-- Dumping data for table servix_db.recomendaciones: ~2 rows (approximately)
...
INSERT INTO `recomendaciones` (`id`, `id_usuario`, `nombre`, `email`, `urlRec`, `fecha`) VALUES
	...
	(3, 1, 'javier', 'jace@asd.com', 'http://localhost/servix2014/web/ficha/208-herreria-los-hermanos', '2014-11-28 04:18:31');
...
-- Dumping data for table servix_db.usuarios: ~9 rows (approximately)
DELETE FROM `usuarios`;
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `email`, `clave`, `nombre`, `apellido`, `telefono`, `direccion`, `foto`, `codigo`, `estado`, `fecha_creacion`, `fecha_mod_estado`, `ultima_edicion`) VALUES
	(1, 'pepe@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Pedro', 'DonCorlione', '4444-5587', 'Av. Libertador 5966', 'b947763fde0584f5278ca2236886d829.jpg', 'aaaaaaaaa', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '2014-11-28 11:11:49'),
	(2, 'usuario1@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Juan', 'Moreno', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa1', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(3, 'usuario2@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Sofia', 'Carlo', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa2', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(4, 'usuario3@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Melina', 'Paz', '4444-5587', 'Av. Libertador 5966', '', 'aaaaaaaaa3', 1, '2014-11-03 21:09:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
