...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Guarda las busquedas de servicios temporales';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Guarda los favoritos de los usuarios';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Guarda las postulaciones temporales de servicios';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1 COMMENT='Guarda el comentario, puntuacion, fecha del comentario y fecha de uso realizado por un usuario sobre un servicio';
...
INSERT INTO `puntuacion` VALUES ('11', '5', '208', '3', 'lorem  lorem lorems lorem  lorem lorems lorem  lorem lorems ', '2014-11-15 11:28:54', '2014-11-19 03:01:03');
...
INSERT INTO `relacion_u_s` VALUES ('2', '10', '521');
INSERT INTO `relacion_u_s` VALUES ('3', '11', '522');
...
CREATE TABLE `usuarios` (
  ...
  UNIQUE KEY `dni` (`dni`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='Guarda los datos de usuario';
...
-- ----------------------------
-- Table structure for `zzzcomentarios`
-- ----------------------------
DROP TABLE IF EXISTS `zzzcomentarios`;
CREATE TABLE `zzzcomentarios` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_usuarios` int(11) unsigned NOT NULL,
  `id_servicios` int(11) unsigned NOT NULL,
  ...
  KEY `id_usuarios` (`id_usuarios`),
  KEY `id_servicios` (`id_servicios`),
  CONSTRAINT `zzzcomentarios_ibfk_1` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `zzzcomentarios_ibfk_2` FOREIGN KEY (`id_servicios`) REFERENCES `servicios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='esta tabla nose usa por eso le puse zzz\r\ndespues hay que borrarla';

-- ----------------------------
-- Records of zzzcomentarios
-- ----------------------------
