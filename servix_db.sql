...
CREATE TABLE `comentarios` (
  ...
  CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- ----------------------------
INSERT INTO `servicios` VALUES ('3', '1', '597', 'trousers public wide stick keep', 'mark profit front step thing hand cushion thr', '100/100', 'http://google.com/', '{alguna calle 2145}', '637-888-9670', '10', '260');
INSERT INTO `servicios` VALUES ('30', '2', '1666', 'degree', 'wrong distance request bright like stem thin ', 'side present side west root common stocking h', 'kick moon good property road sound short poli', '3609 State Loop 1', '355-908-8964', '124930292', '792375873');
INSERT INTO `servicios` VALUES ('47', '24', '1589', 'cotton nail river', 'ill brick insect', 'some effect stitch rhythm broken song kind do', 'sand blow with high division fat together min', '3753 State Hwy 70G Bus', '267-582-4736', '630076610', '182578414');
INSERT INTO `servicios` VALUES ('57', '12', '270', 'porter come side', 'fat knife slip river power great', 'as hat heart long clock crime apple then enou', 'harbour lip all drop than rain news cork song', '796 State Loop 458', '554-859-2069', '411472431', '55321903');
INSERT INTO `servicios` VALUES ('64', '36', '737', 'sock stiff fight', 'science', 'lip train son with because harmony dirty mass', 'bottle brick present belief seat week country', '34305 E Hurst', '848-067-5338', '770665544', '733742221');
INSERT INTO `servicios` VALUES ('67', '10', '87', 'love through', 'expert off mine farm safe name leaf produce f', 'print detail thing change whistle harbour at ', 'now shelf balance example apparatus move whil', '735 2nd St', '710-204-3126', '471541499', '618210106');
INSERT INTO `servicios` VALUES ('74', '12', '826', 'knee take death loose', 'horn wax war', 'wash motion spade hook metal religion summer ', 'operation food answer burn angry pencil card ', '162 Eldorado Pkwy', '678-162-9399', '415391085', '771374111');
INSERT INTO `servicios` VALUES ('105', '6', '680', 'public', 'structure boy nation family fall theory disgu', 'tray mountain cook complex open verse drawer ', 'attack cause house left silver look dependent', '2594 Beltway 8', '210-542-3199', '191605195', '528202241');
INSERT INTO `servicios` VALUES ('126', '31', '439', 'waiting', 'whip nose heart screw stamp basket reason', 'tomorrow breath bridge open match bad balance', 'join blood print frame any boy little blood s', '7830 FM 1191', '613-335-7907', '446014627', '18062313');
INSERT INTO `servicios` VALUES ('137', '18', '1124', 'married till conscious', 'time', 'cheap physical coat lead cry hat rail stateme', 'sort sock silk broken brass any destruction l', '81 S State Hwy 18', '847-678-2514', '335334585', '177533826');
INSERT INTO `servicios` VALUES ('138', '3', '295', 'silk not I', 'electric view among feeble sound military ham', 'crack see verse tooth meat cart value complet', 'muscle floor woman red table waste country po', '93689 N State Hwy 79', '844-775-5793', '496311929', '228784283');
INSERT INTO `servicios` VALUES ('147', '28', '2108', 'pleasure music table act', 'plant breath punishment unit sudden', 'tired steel comfort chin back simple stone ta', 'stocking plate summer destruction twist fowl ', '45767 US Hwy 90U Bus', '606-845-1455', '371332870', '191471041');
INSERT INTO `servicios` VALUES ('193', '21', '1412', 'now angle', 'hospital stomach than profit', 'ticket very fixed watch grip mother necessary', 'sort fear poor committee level probable ficti', '27697 US Hwy 81D Bus', '145-690-6530', '326322070', '216826337');
INSERT INTO `servicios` VALUES ('204', '12', '1204', 'tray line', 'needle suggestion stretch', 'society wide second test clean cruel very orn', 'jump condition powder tree up regular thumb b', '49777 Doak St', '362-147-9691', '379852742', '11069465');
INSERT INTO `servicios` VALUES ('208', '22', '987', 'for different', 'news test', 'statement writing space form will complete na', 'price field ball foolish expert poison comb s', '68 E San Antonio St', '103-513-0952', '616045391', '368331190');
INSERT INTO `servicios` VALUES ('226', '8', '279', 'over thin root learning', 'cloud transport rail out prison free separate', 'fire such news decision near account line pro', 'arch coal twist pin milk till brain kind blue', '5068 FM 852', '186-704-1261', '698183890', '671562056');
INSERT INTO `servicios` VALUES ('244', '37', '413', 'basin', 'ear bed', 'credit canvas hospital cold whistle rest moon', 'low order room apparatus complete crack level', '628 US Hwy 259', '581-510-7535', '340245738', '217866679');
INSERT INTO `servicios` VALUES ('262', '3', '612', 'night', 'branch brick flame competition person history', 'station kiss through yellow brush language ha', 'increase east bridge development grass drawer', '630 Byrd Ave', '650-850-9951', '119930610', '183885541');
INSERT INTO `servicios` VALUES ('329', '31', '832', 'different', 'where smash scissors machine feeble pocket by', 'hard regular near name south left put time ab', 'metal coat flame organizatio where self sad s', '30038 N Upshaw Blvd', '818-437-4339', '725429730', '633284882');
INSERT INTO `servicios` VALUES ('334', '18', '419', 'impulse potato slow', 'business dress blue verse chin', 'clear bit request bell healthy he balance sou', 'summer reward discovery fruit cushion fact ey', '96 Carolina St', '280-254-8069', '636235724', '730619451');
INSERT INTO `servicios` VALUES ('349', '15', '380', 'doubt bag', 'door peace man door owner late', 'current breath drawer hollow dust circle comb', 'balance monkey low line cup news cover wool i', '62 FM 1244 E', '902-629-0288', '766668750', '686953936');
INSERT INTO `servicios` VALUES ('384', '10', '2276', 'smell', 'play cheese wise whip crack violent sugar tra', 'mind kick hand whistle thought plant rain spe', 'certain prison slope finger toe leg plant cup', '33 W Dale St', '331-075-2690', '472525998', '506984472');
INSERT INTO `servicios` VALUES ('495', '35', '460', 'give', 'desire wet iron exchange prose mind language ', 'dress give shut baby full year ring expert wa', 'linen memory school operation ever as brush a', '63982 Western Ave', '709-851-2282', '779646299', '254414507');
INSERT INTO `servicios` VALUES ('496', '17', '394', 'name observation', 'pin crack feeble', 'punishment material level beautiful table cha', 'bed seem slip history dear smooth support wav', '45 Uvalde Rd', '616-867-3710', '218239622', '191952107');
INSERT INTO `servicios` VALUES ('497', '25', '2242', 'fertile', 'cord cough substance', 'thought experience before memory wave train m', 'farm grass button eye paste feather company f', '65698 S Getty St', '433-501-2199', '294032683', '129149595');
INSERT INTO `servicios` VALUES ('498', '26', '1983', 'military leather oven list', 'oil impulse selection false discussion star h', 'among middle then loose watch wise purpose di', 'married division slope book stitch roll mount', '863 S US Hwy 287 Nb', '633-371-2190', '778628275', '101464927');
INSERT INTO `servicios` VALUES ('499', '15', '2041', 'serious direction', 'he spoon spring song front minute end cloth w', 'competition kick vessel foolish art colour ta', 'opinion cheese cork seem hole week snow curta', '862 W Center Ave', '570-182-5396', '178322163', '440931198');
INSERT INTO `servicios` VALUES ('500', '28', '774', 'military needle', 'ant body', 'degree grain lock bread map floor join idea r', 'take observation pot summer face manager not ', '93442 Salinas Ave', '664-971-4876', '307077067', '629452623');
INSERT INTO `servicios` VALUES ('501', '13', '810', 'brain', 'reward bone position island umbrella keep lan', 'before across condition bird nation wax baske', 'bright leaf leg loud opposite pin expert wine', '4937 Commerce St', '974-691-6149', '700771044', '198657393');
INSERT INTO `servicios` VALUES ('502', '22', '1868', 'red the book instrument', 'silver side bee destruction', 'room secretary plant false help writing accou', 'town dark pipe polish brother way false shelf', '55347 W Dale St', '619-493-3068', '638502676', '10399043');
INSERT INTO `servicios` VALUES ('503', '35', '199', 'lock that ink', 'history bone before sound brush fact', 'money small reason hat rain hat other door il', 'unit relation print bed pump business fat thu', '7863 State Hwy 289 Bus', '247-145-0960', '346658131', '517105212');
INSERT INTO `servicios` VALUES ('504', '13', '2286', 'death', 'machine organizatio wide round minute', 'harbour door house even body shake ornament w', 'up feeling who library hour able feeble offer', '902 Spr 231', '968-141-8449', '642806783', '479970430');
INSERT INTO `servicios` VALUES ('505', '38', '332', 'paint', 'chalk group safe', 'unit smash take cheese good reward key flat t', 'chemical damage quick than expansion green hi', '159 State Hwy 65', '183-342-1237', '157405003', '480807690');
INSERT INTO `servicios` VALUES ('506', '10', '1648', 'reason', 'important butter scissors hard walk a stiff o', 'leaf seem desire smoke competition cook milk ', 'again wax yesterday past kiss voice approval ', '4281 State Hwy 37 Alt', '732-782-3997', '298413536', '353937012');
INSERT INTO `servicios` VALUES ('507', '19', '358', 'system hand sound', 'cord pen violent if snake distance government', 'purpose cat house edge doubt than enough ever', 'very air bed wine nerve public swim material ', '56 Sr348', '672-183-8977', '76627760', '201219738');
INSERT INTO `servicios` VALUES ('508', '10', '546', 'curtain false parcel late', 'after start salt send broken sheep chin dry p', 'danger representat as dust for company silver', 'experience come oven attempt attraction feath', '4664 Amber', '761-350-5185', '89855551', '239518099');
INSERT INTO `servicios` VALUES ('509', '15', '2213', 'cheese then addition', 'noise chain insect sun heart down same sign w', 'unit stocking month bitter some stitch hope p', 'shut by money comb store fire voice request m', '9478 State Loop 564', '299-167-4105', '58303606', '771837626');
INSERT INTO `servicios` VALUES ('510', '1', '872', 'round bath chance necessary', 'fire for drawer roof loss', 'dependent love sense old crack protest father', 'stage box hanging smoke and growth taste writ', '5792 Roland Ave', '486-137-6548', '416539072', '665122970');
INSERT INTO `servicios` VALUES ('511', '22', '2181', 'put smash fork', 'wax view sister business make smash', 'crush true off cruel error liquid tooth late ', 'throat value current number daughter adjustme', '21 FM 487', '382-727-1001', '421269319', '770857262');
INSERT INTO `servicios` VALUES ('512', '17', '48', 'wet horn attraction', 'loud farm boot flower common sheep chief soci', 'porter expansion pain same digestion second e', 'branch ice wire exchange linen tired school w', '51 Cbd-Fair Park Link', '355-216-7347', '633422434', '353872004');
INSERT INTO `servicios` VALUES ('513', '26', '696', 'oven smooth', 'cold', 'equal monkey against coat or go bright appara', 'quiet competition run existence arm mind wood', '7550 S US Hwy 287', '786-536-4431', '268897645', '612829510');
INSERT INTO `servicios` VALUES ('514', '37', '55', 'form square', 'steam lead test down finger political swim in', 'talk card effect money yellow boy limit all a', 'do protest cotton mist please increase almost', '293 SE Loop 281', '194-084-5288', '595874535', '153275065');
INSERT INTO `servicios` VALUES ('515', '19', '1204', 'blade smash sound certain', 'government let library page news other number', 'expansion match trouble burst wound old grain', 'have solid cup harmony food wing down young l', '515 S Smith Ave', '690-469-6550', '657972316', '761113410');
INSERT INTO `servicios` VALUES ('516', '30', '1285', 'yellow butter fertile society', 'record language meal bitter boiling train lov', 'linen writing very stretch conscious strange ', 'with flight love basket send middle low bed n', '232 E Leona St', '748-931-5897', '379126042', '321301679');
INSERT INTO `servicios` VALUES ('517', '4', '1451', 'net middle comfort', 'base discovery room jewel fork sky safe silk', 'serious bell fixed narrow steam substance use', 'bag effect digestion store month with coat co', '18 Hwy 67 E', '603-620-3353', '505777127', '116113709');
INSERT INTO `servicios` VALUES ('518', '36', '2181', 'thumb drink brass', 'desire water probable statement round crack c', 'fold north feeble expert scale stomach use or', 'let theory cook discussion dress impulse west', '90 W 6th St', '522-558-8679', '267337458', '652185998');
INSERT INTO `servicios` VALUES ('519', '34', '978', 'horn discovery pain', 'no condition like sky south snow parallel', 'bridge road after loud false have burn pull a', 'love theory wave fight bridge bell do unit fe', '20010 Morelos Ave', '193-003-6582', '217007333', '522109329');
INSERT INTO `servicios` VALUES ('520', '24', '2089', 'polish free', 'fact guide ear', 'edge wound record knot humour drop drain shor', 'place wind go insurance cause cart operation ', '2695 NW Loop 564', '275-423-7021', '736060986', '123638337');
...
-- Records of usuarios
-- ----------------------------
INSERT INTO `usuarios` VALUES ('3', 'yesenia.nadia@fiction.info', 'disease brown', 'branch copper', 'please family', '12110593', 'committee error', '0');
INSERT INTO `usuarios` VALUES ('4', 'lucio.jerrod.weston@leatherleft.me', 'while floor', 'heat under', 'oil sand', '13089801', 'thin on', '1');
INSERT INTO `usuarios` VALUES ('5', 'mavis.callie@scissors.org', 'seem tired', 'train jelly', 'hole wax', '22664634', 'arm committee', '2');
INSERT INTO `usuarios` VALUES ('6', 'cindy.grace@rhythmrice.me', 'system name', 'wash mother', 'roof little', '15439347', 'chalk button', '1');
INSERT INTO `usuarios` VALUES ('7', 'karina.eve@jeweljoin.org', 'move sea', 'list winter', 'change mouth', '41987915', 'process angle', '1');
