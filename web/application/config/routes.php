...
$route['verificar-usuario']	        						= "login/verificar_usuario_email";
$route['validar_usuario_newCodigo']	        				= "login/validar_usuario_newCodigo";
...
$route['actualizar_foto_perfil']					= "usuario/actualizar_foto_perfil";
