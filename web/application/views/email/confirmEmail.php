...
<head>
	...
	<title>Confirmación de e-mail de registro en <?php echo APP_NAME;?></title>
			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">¡Bienvenido a <?php echo APP_NAME;?>! Acabas de unirte al mejor sitio para buscar servicios y compartir tus servicios con la comunidad. 
							¡Nos alegra que estés aquí! </p>
						<p class="lead">Antes de que empieces a explorar servicios y compartir tus propios servicios en <?php echo APP_NAME;?>, 
