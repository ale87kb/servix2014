			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">Antes de que empieces a explorar servicio y compartir tus propios servicios en Servix, 
							debemos confirmar que eres una persona y no un robot.</p>
						<p class="lead">Para completar el registro, haz click en el siguiente boton:</p>
