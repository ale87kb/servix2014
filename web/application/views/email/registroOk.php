...
<head>
	...
	<title>Gracias por iniciar session en <?php echo APP_NAME;?></title>
			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">Haz iniciado sesion en <?php echo APP_NAME;?> con facebook, y nos hemos tomado la libertad de registrarte en nustro sitio.<br>
						Te generamos una cuenta con los siguientes datos de ingreso:
						</p>
						<p class="callout">
