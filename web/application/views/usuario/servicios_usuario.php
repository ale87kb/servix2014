...
<div class="col-md-12">
  ...
  ?>
    <div class="row">
      <div class="col-md-10">
        <figure>
          <img src="<?php echo $ser->foto_path; ?>" alt="<?php echo ucfirst($ser->titulo); ?>" class="pull-left img-responsive" width="125">
        </figure>
          <h3 class="list-group-item-text"><a href="<?php echo $ser->link_servicio; ?>"><?php echo ucfirst($ser->titulo); ?></a></h3>
