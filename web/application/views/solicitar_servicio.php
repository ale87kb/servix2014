	...
	<div class="jumbotron col-md-12">
		<div class="row">
			...
			<div class="col-md-6 guia-uso">
				...
				<ul>
					<li>
						<p>Busca tu categoria, en la cual solicitas el servicio, si no aparece en el listado, será asignada a la categoria de "<strong>Otros</strong>".</p>
					</li>
					<li>
					...
					<li>
						...
						Si quieres reactivar la solicitud , solo debes entrar a tu <a href="#">perfil</a> y reactivarla.</p>
					</li>
					<!-- <li>
						<p>
